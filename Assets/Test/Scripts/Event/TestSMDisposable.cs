...
namespace SubmarineMirage.TestEvent {
	...
	public class TestSMDisposable : SMUnitTest {
		...
		public IEnumerator TestModifyler() => From( async () => {
			TestSMEventSMUtility.SetModifyler( _events, a => Disposable.Create( a ), startName => {
		...
		public IEnumerator TestChangeWhileRunning() => From( async () => {
			TestSMEventSMUtility.SetChangeWhileRunning( _events, a => Disposable.Create( a ), startName => {
				SMLog.Debug( _events );
		...
		public IEnumerator TestManual() => From( async () => {
			_disposables.AddLast( TestSMEventSMUtility.SetKey( _events, a => Disposable.Create( a ) ) );
