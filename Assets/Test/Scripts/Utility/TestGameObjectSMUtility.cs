...
namespace SubmarineMirage.TestUtility {
	...
	public class TestGameObjectSMUtility : SMStandardTest {
		...
		public void CreateTestGetComponentsInParentUntilOneHierarchy() => TestSMBehaviourSMUtility.CreateBehaviours(
			@"
				M1, M1,
					M1, M1,
						false,
