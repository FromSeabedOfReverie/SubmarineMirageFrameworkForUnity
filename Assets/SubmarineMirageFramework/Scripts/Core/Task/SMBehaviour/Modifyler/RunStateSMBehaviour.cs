...
namespace SubmarineMirage.Task.Modifyler {
	...
	public class RunStateSMBehaviour : SMBehaviourModifyData {
		...
		void Create() {
			...
			SMLog.Debug( $"{_body._owner.GetAboutName()}.{nameof(Create)} :\n{_body}" );
#endif
			_body._owner.Create();
...
#if TestSMTaskModifyler
			SMLog.Debug( $"{_body._owner.GetAboutName()}.{nameof(SelfInitialize)} :\n{_body}" );
#endif
...
#if TestSMTaskModifyler
			SMLog.Debug( $"{_body._owner.GetAboutName()}.{nameof(Initialize)} :\n{_body}" );
#endif
		...
		async UniTask Finalize() {
			...
			if ( _body._isActive ) {
#if TestSMTaskModifyler
				SMLog.Debug( $"{_body._owner.GetAboutName()}.{nameof(Finalize)} : Register Disable :\n{_body}" );
#endif
...
#if TestSMTaskModifyler
			SMLog.Debug( $"{_body._owner.GetAboutName()}.{nameof(Finalize)} :\n{_body}" );
#endif
