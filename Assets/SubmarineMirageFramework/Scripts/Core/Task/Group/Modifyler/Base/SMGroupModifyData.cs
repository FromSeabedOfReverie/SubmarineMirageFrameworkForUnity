...
namespace SubmarineMirage.Task.Modifyler {
	...
	public abstract class SMGroupModifyData : SMLightBase {
		...
		[SMShowLine] public ModifyType _type	{ get; protected set; }
		[SMShowLine] public SMObject _object	{ get; protected set; }
		public SMObjectModifyler _owner	{ get; set; }
		protected SMGroup _group => _owner?._owner;



		public SMGroupModifyData( SMObject smObject ) {
			_object = smObject;
			...
			SMLog.Debug( $"{nameof( SMGroupModifyData )}() : {this}" );
#endif
		}
		...
		public static void AddChildObject( SMObject parent, SMObject add ) {
#if TestSMTaskModifyler
			SMLog.Debug( $"{nameof( AddChildObject )} : start" );
			...
			SMLog.Debug( $"{nameof( AddChildObject )} : end" );
#endif
		}
		...
		public static void UnLinkObject( SMObject smObject ) {
#if TestSMTaskModifyler
			SMLog.Debug( $"{nameof( UnLinkObject )} : start" );
			...
			SMLog.Debug( $"{nameof( UnLinkObject )} : end" );
#endif
		}
