...
namespace SubmarineMirage.Task.Group.Manager.Modifyler {
	...
	public class RunStateSMGroupManager : SMGroupManagerModifyData {
		...
		public RunStateSMGroupManager( SMTaskType taskType, SMTaskRunState state ) : base( null ) {
			_taskType = taskType;
			_state = state;
...
//					return;
				...
				default:
					owner._modifyler.Register( new RunStateSMGroupManager( taskType, state ) );
					return;
			}
		}
	}
