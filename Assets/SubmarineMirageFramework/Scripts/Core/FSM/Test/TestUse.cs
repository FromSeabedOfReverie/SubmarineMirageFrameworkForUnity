...
namespace SubmarineMirage.FSM.Test {
	...
	public class Human : SMBehaviour, ISMFSMOwner {
	...
	public class Dragon : SMBehaviour, ISMFSMOwner {
		public bool _isInitialEnteredFSMs	{ get; set; }
		public SMFSM _fsm	{ get; private set; }
...
//							new NormalDummyState(),			// エラー
	...
	public class Dummy : SMBehaviour, ISMFSMOwner {
		public bool _isInitialEnteredFSMs	{ get; set; }
		public SMFSM _fsm	{ get; private set; }
		public override void Create() {
			_fsm = SMFSM.Generate(
