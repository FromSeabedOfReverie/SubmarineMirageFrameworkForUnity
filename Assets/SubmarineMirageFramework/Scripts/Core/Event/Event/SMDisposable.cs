...
namespace SubmarineMirage.Event {
	...
	public class SMDisposable : BaseSMEvent<IDisposable> {
		...
		public void InsertFirst( string findKey, string key, Action function )
			=> _modifyler.Register( new InsertSMEvent<IDisposable>(
		...
		public void InsertFirst( string findKey, string key, params IDisposable[] functions )
			=> functions.ForEach( f => _modifyler.Register( new InsertSMEvent<IDisposable>(
		...
		public void AddFirst( string key, Action function )
			=> _modifyler.Register( new AddSMEvent<IDisposable>(
		...
		public void AddFirst( string key, params IDisposable[] functions )
			=> functions.ForEach( f => _modifyler.Register( new AddSMEvent<IDisposable>(
