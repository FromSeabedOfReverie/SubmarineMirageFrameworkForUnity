...
namespace SubmarineMirage.Data {
	...
	/// </summary>
	///====================================================================================================
	public class AllDataManager : SMTask, ISMService {
		///------------------------------------------------------------------------------------------------
		/// ● 要素
		///------------------------------------------------------------------------------------------------
		...
		public readonly SMSaveDataManager _save = new SMSaveDataManager();
		...
		public override async UniTask Load() {
			...
			// 読込成功の場合
			if ( SMFileManager.s_instance._isSuccess ) {
				Log.Debug( $"{this.GetAboutName()} : 読込完了", Log.Tag.Data );
			}
			SMFileManager.s_instance.ResetAllCount();  // 計測初期化
