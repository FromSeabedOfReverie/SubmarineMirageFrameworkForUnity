...
namespace SubmarineMirage.SMTask {
	...
	public class SMGroup : SMStandardBase {
		...
		[Hide] public SMGroupManager _groups => _scene?._groups;
		public SMObjectModifyler _modifyler	{ get; private set; }

		[ShowLine] public SMGroup _previous;
		[ShowLine] public SMGroup _next;

		[ShowLine] public SMObject _topObject;
		[Hide] public GameObject _gameObject => _topObject._owner;
		[Hide] public bool _isGameObject =>	_gameObject != null;

		[Hide] public UTaskCanceler _asyncCanceler =>	_topObject._asyncCanceler;
